...
{
    return simulator.noLinAcc();
}

void Circuit::setNoLinAcc( int ac )
{
    simulator.setNoLinAcc( ac );
}

int Circuit::reactStep()
{
    return simulator.reaClock();
}

void Circuit::setReactStep( int steps )
{
    simulator.setReaClock( steps );
}

int Circuit::noLinStep()
{
    return simulator.noLinClock();
}

void Circuit::setNoLinStep( int steps )
{
    simulator.setNoLinClock( steps );
}

int Circuit::circSpeed()
{
    return simulator.simuRate();
}
void Circuit::setCircSpeed( int rate )
{
    simulator.simuRateChanged( rate );
}
