...
Component* Lm555::construct( Circuit* parent, QString type, QString id )
{
...
Lm555::Lm555( Circuit* parent, QString type, QString id )
     : Component( parent, type, id )
     , eLm555(  parent->getSimulatorPtr(), id.toStdString() )
{
    ...
    m_ePin[4] = m_pin[4];
    newId.append("-eSource");
    m_cv = new eSource( parent->getSimulatorPtr(), newId.toStdString(), m_ePin[4] );
    m_cv->setImp( 10 );
    m_cv->setOut( true );
    ...
    m_ePin[6] = m_pin[6];
    newId.append("-eSource");
    m_dis = new eSource( parent->getSimulatorPtr(), newId.toStdString(), m_ePin[6] );
